...
(function ($) {
    $(document).ready(function () {
        ...
        /* 주소록 정렬 */
        setFunction(".address_align ul li", 'click', function () {
            $(".address_align ul li.on").removeClass("on");
            $(this).toggleClass("on");
        });
        ...
        /* 언어 설정 */
        $(".com_chk.language li").click(function () {
            $(this).addClass("on");
            $(this).siblings().removeClass("on");
        });

        /* 스킨 설정 */
        $(".com_chk.skin li").click(function () {
            $(this).addClass("on");
            $(this).siblings().removeClass("on");
        });

        /* 알림 설정 */
        $(".notification_list li.active .tit p").click(function (e) {
            $(e.target).closest("li").toggleClass("on");
            $(this).slideDown(200).parent().siblings().children(".notification_sublist").hide();
            $(this).parent().siblings().removeClass("on");
        });

        /* 검색 메뉴 */
        $(".search_menu_wrap .tab_box li a").click(function () {
            $(".search_menu_wrap .tab_box li a").removeClass("on");
            $(this).addClass("on");
            $(".search_content").hide();
            $($(this).attr("href")).show();
            return false;
        ...
        /* 인기 검색어 */
        $(".hot_tab_menu li a").click(function () {
            $(".hot_tab_menu li a").removeClass("on");
            $(this).addClass("on");
            $(".hot_tab_content").hide();
            $($(this).attr("href")).show();
            return false;
        });
        ...
        function slide() {
            ...
            function slideEvent() {
                ...
                $pagenationli.click(function () {
                    ...
                    wid = $item.children('.slide-box').width();
